...
public class FilesTriplesRecordReader extends RecordReader<TripleSource, Triple> {
	MultiFilesSplit split = null;
	TaskAttemptContext context = null;
	
	private SequenceFileRecordReader<TripleSource, Triple> rr = 
		new SequenceFileRecordReader<TripleSource, Triple>(); 
	int i = 0;
